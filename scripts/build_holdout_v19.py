#!/usr/bin/env python3
"""Build blind V19 from pre-cutoff verified operating evidence."""
...
TARGET = ROOT / "evaluation" / "holdout-v19"
CUTOFF = "2026-05-01"

STARTUPS = ["傲意科技", "因时机器人", "众擎机器人", "星环聚能", "星海图", "星尘智能"]
...
def main() -> None:
    ...
    evidence: list[dict] = []
    strict_targets = set(STARTUPS + LISTED[:3])
    ...
    manifest = {
        "holdout_version": "holdout-v19", "frozen_at": "2026-07-29", "cutoffs": [CUTOFF], "horizon_months": 3,
        "prompt_version": "historical-demand-v11-top3-business-owner-delivery", "prediction_max_roles_per_company": 3,
    ...
    (TARGET / "evidence.json").write_text(json.dumps({"dataset_version":"2026-07-29-holdout-v19","evidence":evidence}, ensure_ascii=False, indent=2), encoding="utf-8")
    (TARGET / "manifest.json").write_text(json.dumps(manifest, ensure_ascii=False, indent=2), encoding="utf-8")
    (TARGET / "README.md").write_text("# Holdout V19\n\nIndependent top-3 replay after V18 business-owner and project-delivery calibration. Future recruiting labels stay closed until the prediction snapshot is sealed.\n", encoding="utf-8")
    ...
    seal = {"holdout_version":"holdout-v19", "sealed_at":"2026-07-29T03:00:00+08:00", "prediction_started":False, "future_label_search_started":False,
